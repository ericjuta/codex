...
| Block finding | `/tmp/hashline/crates/core/src/commands/find_block.rs`, `/tmp/hashline/crates/core/src/block.rs` | Uses extension-driven brace, Markdown section, Python/Verse indentation, and Ruby-ish block rules. |
