...
use super::hashline_patch_parser::apply_patch_contamination_message;
use super::hashline_patch_parser::hashline_operation_has_payload;
use super::hashline_patch_parser::is_hashline_operation_line;
use super::hashline_patch_parser::is_ignorable_patch_line;
